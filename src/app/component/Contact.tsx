            ...
            <form action="https://formspree.io/f/mzzpoldg" method="POST">
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full rounded border border-gray-600 focus:ring-2 focus:ring-white
                   ...
                   -100 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out bg-white"
                  required
                />
              </div>
              <div className="relative mb-4">
              ...
              <div className="relative mb-4 bg-white">
                ...
                <textarea
                  id="Message"
                  name="Message"
                  className="w-full  rounded border border-gray-600 focus:ring-2 focus:ring-purple-700 h-32 text-base outline-none text-black
                  -100 py-2 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out bg-white"
                  required
                />
              </div>
