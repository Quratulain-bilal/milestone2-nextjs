      ...
      <footer className="text-white body-font bg-gradient-to-r from-black to-purple-900">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start gap-4 text-white items-center">
            ...
            >
              <FaFacebookSquare className="w-[28px] h-[28px] text-white hover:text-[#1877F2] hover:-translate-y-1" />
            </a>
            <a
              href="https://x.com/stelalvna"
              className="transition-all duration-300 hover:scale-110"
            >
              <FaSquareXTwitter className="w-[28px] h-[28px] text-white hover:text-gray-100 hover:-translate-y-1" />
            </a>
            <a
              href="https://www.instagram.com/muhammadsalah9544/"
              className="transition-all duration-300 hover:scale-110"
            >
              <FaInstagramSquare className="w-[28px] h-[28px] text-white hover:text-[#fa7e1e] hover:-translate-y-1" />
            </a>
            <a
              href="https://github.com/Quratulain-bilal"
              className="transition-all duration-300 hover:scale-110"
            >
              <FaSquareGithub className="w-[28px] h-[28px] text-white hover:text-[#6e5494] hover:-translate-y-1" />
            </a>
            <a
              href="https://www.linkedin.com/in/quratulain-shah-7bb869316"
              className="transition-all duration-300 hover:scale-110"
            >
              <FaLinkedin className="w-[28px] h-[28px] text-white hover:text-[#0072b1] hover:-translate-y-1" />
            </a>
          </span>
        </div>
      </footer>
